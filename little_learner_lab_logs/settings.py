"""
Django settings for little_learner_lab_logs project.
...
CRISPY_TRMPLATE_PACK = 'bootstrap 4'
...
ROOT_URLCONF = 'little_learner_lab_logs.urls'
...
WSGI_APPLICATION = 'little_learner_lab_logs.wsgi.application'
